...
class RoutingProvider{
    constructor($urlRouterProvider, $httpProvider, $locationProvider, $futureStateProvider) {
        ...
        */
        ...
        this.$get = RouterConfiguration;
    
   
        RouterConfiguration.$inject = ['$location', '$rootScope', '$state', 'logger']; 
        
        
        function RouterConfiguration($location, $rootScope, $state, logger) {
...
//                                         
//                         let msg = `Erro de roteamento ao acessar ${destination}. ${error.data || ''} <br/> 
