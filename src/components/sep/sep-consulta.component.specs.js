...
import SepConsultaTemplate from './sep-consulta.component.html!text';
...
describe( 'SepConsulta', () => {
    ...
    describe( 'Controller', () => {
        ...
        describe( 'toggleUpdates()', () => {
            ...
            it( 'should call $ionicScrollDelegate if showAllUpdates false', () => {
                controller.showAllUpdates = false;
                controller.toggleUpdates();
